    ...
    env.app.post(`/data/${env.db.name}/*`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (err instanceof acebase_1.SchemaValidationError) {
                ...
                (_e = env.logRef) === null || _e === void 0 ? void 0 : _e.push({ action: 'update_data', success: false, code: err.code, path, ip: req.ip, uid: (_g = (_f = req.user) === null || _f === void 0 ? void 0 : _f.uid) !== null && _g !== void 0 ? _g : null });
                (0, error_1.sendBadRequestError)(res, err);
            }
            else {
                env.debug.error(`failed to update "${path}":`, err);
                (_h = env.logRef) === null || _h === void 0 ? void 0 : _h.push({ action: 'update_data', success: false, code: `unknown_error`, path, error: err.message, ip: req.ip, uid: (_k = (_j = req.user) === null || _j === void 0 ? void 0 : _j.uid) !== null && _k !== void 0 ? _k : null });
